...
export namespace ClientMessage {
  export function isTerminateMessage(message: ClientMessage): message is ClientMessageTerminate {
    return message?.action === 'terminate';
  }

  export function isLoadMessage(message: ClientMessage): message is ClientMessageLoad {
    return message?.action === 'load';
  }

  export function isSetMessage(message: ClientMessage): message is ClientMessageSet {
    return message?.action === 'set';
  }

  export function isAudioChunkMessage(message: ClientMessage): message is ClientMessageAudioChunk {
...
export namespace ModelMessage {
  export function isLoadResult(message: any): message is ServerMessageLoadResult {
...
export namespace ServerMessage {
  ...
  export function isPartialResult(message: any): message is ServerMessagePartialResult {
